...
void createObjects(Employee *a1[3], Project *a2[3])
{
    ...
    a1[0]=new Employee("e101","sahana",6700.0f,Department::INTEGRATION,a2[2]);
    a1[1]=new Employee("e102","sahana",6700.0f,Department::INTEGRATION,a2[2]);
    a1[2]=new Employee("e103","sahana",6700.0f,Department::INTEGRATION,a2[2]);
    for(int i=0;i<3;i++)
    {
        std::cout<<"object: \n"<<*a1[i]<<"\n";
    }
